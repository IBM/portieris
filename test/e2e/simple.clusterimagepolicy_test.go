...
func TestSimple_ClusterImagePolicyRepositories_AllowAllDenyAll(t *testing.T) {
	utils.CheckIfTesting(t, testSimpleClusterImagePolicy)
...
func TestSimple_ClusterImagePolicyRepositories_Basic(t *testing.T) {
	utils.CheckIfTesting(t, testSimpleClusterImagePolicy)
	t.Run("Allow images signed by the correct single simple signer", func(t *testing.T) {
		t.Parallel()
		namespace := utils.CreateImagePolicyInstalledNamespace(t, framework, "./testdata/clusterimagepolicy/simple-signedby1.yaml", "")
		utils.CreateSecret(t, framework, "./testdata/secret/simple1pubkey.yaml", namespace.Name)
		utils.TestDeploymentRunnable(t, framework, "./testdata/deployment/global-nginx-signed-free.yaml", namespace.Name)
	...
	t.Run("Allow images signed the correct multiple simple signers", func(t *testing.T) {
		t.Parallel()
		namespace := utils.CreateImagePolicyInstalledNamespace(t, framework, "./testdata/clusterimagepolicy/simple-signedby2.yaml", "")
		utils.CreateSecret(t, framework, "./testdata/secret/simple1pubkey.yaml", namespace.Name)
		utils.CreateSecret(t, framework, "./testdata/secret/simple2pubkey.yaml", namespace.Name)
		utils.TestDeploymentRunnableCheck(t, framework, "./testdata/deployment/global-nginx-signed-free.yaml", namespace.Name, utils.VerifySha)
		utils.CleanUpImagePolicyTest(t, framework, namespace.Name)
	})
	t.Run("Allow images signed the correct multiple simple signers with no mutation", func(t *testing.T) {
		t.Parallel()
		namespace := utils.CreateImagePolicyInstalledNamespace(t, framework, "./testdata/clusterimagepolicy/simple-signedby2-nomutate.yaml", "")
		utils.CreateSecret(t, framework, "./testdata/secret/simple1pubkey.yaml", namespace.Name)
		utils.CreateSecret(t, framework, "./testdata/secret/simple2pubkey.yaml", namespace.Name)
		utils.TestDeploymentRunnableCheck(t, framework, "./testdata/deployment/global-nginx-signed-free.yaml", namespace.Name, utils.VerifyNoSha)
		utils.CleanUpImagePolicyTest(t, framework, namespace.Name)
	})
	t.Run("Allow images signed the correct multiple simple signers with explicit mutation", func(t *testing.T) {
		t.Parallel()
		namespace := utils.CreateImagePolicyInstalledNamespace(t, framework, "./testdata/clusterimagepolicy/simple-signedby2-mutate.yaml", "")
		utils.CreateSecret(t, framework, "./testdata/secret/simple1pubkey.yaml", namespace.Name)
		utils.CreateSecret(t, framework, "./testdata/secret/simple2pubkey.yaml", namespace.Name)
		utils.TestDeploymentRunnableCheck(t, framework, "./testdata/deployment/global-nginx-signed-free.yaml", namespace.Name, utils.VerifySha)
		utils.CleanUpImagePolicyTest(t, framework, namespace.Name)
	...
	t.Run("Allow images signed by the correct single simple signer with a secret namespace override", func(t *testing.T) {
		t.Parallel()
		namespace := utils.CreateImagePolicyInstalledNamespace(t, framework, "./testdata/clusterimagepolicy/simple-signedby1-keysecret-namespace-override.yaml", "secretnamespace")
		utils.CreateSecret(t, framework, "./testdata/secret/simple1pubkey.yaml", namespace.Name)
		utils.TestDeploymentRunnableCheck(t, framework, "./testdata/deployment/global-nginx-signed-free.yaml", namespace.Name, utils.VerifySha)
		utils.CleanUpImagePolicyTest(t, framework, namespace.Name)
	})
	...
	t.Run("Allow images matched with remapIdentity policy", func(t *testing.T) {
		t.Parallel()
		namespace := utils.CreateImagePolicyInstalledNamespace(t, framework, "./testdata/clusterimagepolicy/simple-remap.yaml", "")
		utils.CreateSecret(t, framework, "./testdata/secret/simple1pubkey.yaml", namespace.Name)
	...
	t.Run("Allow images without a pullSecret", func(t *testing.T) {
		t.Parallel()
		namespace := utils.CreateImagePolicyInstalledNamespaceNoSecrets(t, framework, "./testdata/clusterimagepolicy/simple-accept-anything.yaml")
	...
	t.Run("Allow images which require a signature without a pullSecret", func(t *testing.T) {
		t.Parallel()
		namespace := utils.CreateImagePolicyInstalledNamespaceNoSecrets(t, framework, "./testdata/clusterimagepolicy/simple-signedby1.yaml")
		utils.CreateSecret(t, framework, "./testdata/secret/simple1pubkey.yaml", namespace.Name)
		utils.TestDeploymentRunnable(t, framework, "./testdata/deployment/global-nginx-signed-free.yaml", namespace.Name)
		utils.CleanUpImagePolicyTest(t, framework, namespace.Name)
	})
