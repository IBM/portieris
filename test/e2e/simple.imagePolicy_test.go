...
func TestSimple_ImagePolicyRepositories_AllowAllDenyAll(t *testing.T) {
	...
	t.Run("Allow all images", func(t *testing.T) {
		t.Parallel()
		namespace := utils.CreateImagePolicyInstalledNamespace(t, framework, "./testdata/imagepolicy/simple-allow-anything.yaml")
...
func TestSimple_ImagePolicyRepositories_Basic(t *testing.T) {
	...
	t.Run("Allow images signed by the correct single simple signer", func(t *testing.T) {
		t.Parallel()
		namespace := utils.CreateImagePolicyInstalledNamespace(t, framework, "./testdata/imagepolicy/simple-signedby.yaml")
		//utils.CreateSecret(t, framework, "./testdata/secret/signer1.pubkey.yaml", namespace.Name)
		utils.TestDeploymentRunnable(t, framework, "./testdata/deployment/global-busybox-simple-signed.yaml", namespace.Name)
		utils.CleanUpImagePolicyTest(t, framework, namespace.Name)
	})
	...
	t.Run("Deny images signed by the wrong single simple signer", func(t *testing.T) {
		...
		//utils.CreateSecret(t, framework, "./testdata/secret/signer2.pubkey.yaml", namespace.Name)
		utils.TestDeploymentNotRunnable(t, framework, "./testdata/deployment/global-busybox-simple-signed.yaml", namespace.Name)
		utils.CleanUpImagePolicyTest(t, framework, namespace.Name)
	})
