...
FROM --platform=$BUILDPLATFORM registry.access.redhat.com/ubi8/go-toolset:1.19.13-2.1698062273 as builder
...
FROM registry.access.redhat.com/ubi8/go-toolset:1.19.13-2.1698062273 as installer
ARG TARGETOS TARGETARCH
USER root
RUN yum update -y
