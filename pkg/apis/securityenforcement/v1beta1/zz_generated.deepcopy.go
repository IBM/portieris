...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VCheck) DeepCopyInto(out *VCheck) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VCheck.
func (in *VCheck) DeepCopy() *VCheck {
	if in == nil {
		return nil
	}
	out := new(VCheck)
