...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IBMVA) DeepCopyInto(out *IBMVA) {
	*out = *in
	if in.Enabled != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IBMVA.
func (in *IBMVA) DeepCopy() *IBMVA {
	if in == nil {
		return nil
	}
	out := new(IBMVA)
...
func (in *Vulnerability) DeepCopyInto(out *Vulnerability) {
	*out = *in
	in.IBMVA.DeepCopyInto(&out.IBMVA)
	return
}
