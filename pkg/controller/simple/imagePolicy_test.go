...
// var simpleSignedByStuart = &v1beta1.Simple{
// 	Type:           "signedBy",
// 	KeyType:        "GPGKeys",
...
// func safePolicyTransform(inPolicy *v1beta1.Simple) *signature.Policy {
// 	policy, err := TransformPolicy(inPolicy)
...
// var policySignedByStuart = safePolicyTransform(simpleSignedByStuart)
...
// 	fmt.Fprint(os.Stdout, "other based policy:", *policySignedByStuart)
